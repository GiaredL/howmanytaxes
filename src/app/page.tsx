...
export default function Home() {
  ...
  useEffect(() => {
    if (income > 0 && budget) {
      ...
      const contribution = calculateTaxContribution(
        calculatedTax,
        totalTaxDollars,
        budgets[budget]
      );
  ...
  if (!isAuth) {
    return (
      <div className={styles.page}>
        <label style={{ marginBottom: "20px", marginTop: "40px" }}>
          enter a password fool
        </label>
        <input
          value={pass}
      ...
      <main className={styles.mainContainer}>
        <div className={styles.heroText}>
          ...
          <p style={{ marginTop: "20px", paddingRight: "40px" }}>
            ATTENTION: this site is currently under development as of June 2025
            and contains some incorrect information. Informational only, not
            tax/legal/financial advice. Consult a professional.
          </p>
        </div>
        ...
        <div className={styles.main}>
          ...
          <div className={styles.heroContainers}>
            ...
            <div className={styles.resultContainer}>
              ...
              <h3>
                Approximate income tax calculation:{" "}
              ...
              <div className={styles.contributionContainer}>
                <p className={styles.contribution}>
                  {formatCurrencyWithSymbol(animatedContribution)}
                </p>
              </div>
            </div>
          </div>
